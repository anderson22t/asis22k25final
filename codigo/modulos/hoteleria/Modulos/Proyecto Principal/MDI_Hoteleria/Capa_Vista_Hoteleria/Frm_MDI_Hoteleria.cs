...
namespace Capa_Vista_Hoteleria
{
    public partial class Frm_MDI_Hoteleria : Form
    {
        ...
        private void tipoMenuToolStripMenuItem_Click(object sender, EventArgs e)
        {
            CerrarFormulariosHijos();
            Frm_TipoMenu tipoMenu = new Frm_TipoMenu();
            tipoMenu.MdiParent = this;
            tipoMenu.Show();
        }
        ...
        {
            CerrarFormulariosHijos();
            Frm_ReportePaciente reportePaciente = new Frm_ReportePaciente();
            reportePaciente.MdiParent = this;
